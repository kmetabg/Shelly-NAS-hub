...
EXTRA_CAMS_CFG_DEFAULT = [
    {
        ...
        "user":       "admin",
        "password":   "admin",
        "snap_url":   "http://192.168.3.120:8080/cgi-bin/api.cgi?cmd=Snap&channel=0&rs=hh&user=admin&password=admin",
        "rtsp_main":  "rtsp://admin:admin@192.168.3.120:554/h264Preview_01_main",
        "rtsp_sub":   "rtsp://admin:admin@192.168.3.120:554/h264Preview_01_sub",
        "has_audio":  True,
    },
]
